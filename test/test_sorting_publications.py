...
from comp61542.database.database import Publication, Database
...
class Test(unittest.TestCase):
    ...
    def testSortByFirstAuthor(self):
        ...
        self.assertEquals([pub3, pub1, pub2], sortedpublist,\
                           "pub3 should come first, then pub1, then pub2. However, the result is " + str(sortedpublist))
    ...
    def test_pub_to_textlist(self):
        pub1 = Publication(0, "Hello2", 2008, ["Author1"])
        pub2 = Publication(0, "Hello0", 1993, ["Author1", "Author2", "Author3"])
        pub3 = Publication(0, "Hello1", 1999, ["Author1", "Author4"])
    ...
    def test_html_generation(self):
        ...
        html = views.displayPublications("year")
